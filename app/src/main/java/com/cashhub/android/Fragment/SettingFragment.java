...
import com.cashhub.android.Activities.InviteFriends;
...
*/
    ...
    private void setListener(View view) {
        ConstraintLayout transCard = view.findViewById(R.id.transCard);
        ConstraintLayout inviteCard = view.findViewById(R.id.inviteCard);
        ConstraintLayout workCard = view.findViewById(R.id.workCard);
        ConstraintLayout supportCard = view.findViewById(R.id.supportCard);
        ConstraintLayout policyCard = view.findViewById(R.id.policyCard);
        ConstraintLayout termsCard = view.findViewById(R.id.termsCard);
        transCard.setOnClickListener(v -> {
            Intent myIntent1 = new Intent(mActivity, com.cashhub.android.Activities.Transactions.class);
        ...
        workCard.setOnClickListener(v -> {
            inAppOpenBrowser("https://mobcash.app/howitwork.html");
        });
        supportCard.setOnClickListener(v -> {
            Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "apphelpmg@gmail.com", null));
