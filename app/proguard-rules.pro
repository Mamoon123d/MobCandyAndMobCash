...
-keep class com.cashhub.android.Activities.GoogleLogin { *; }
-keep class com.cashhub.android.Services.* { *; }
-keep class com.cashhub.android.Models.* { *; }
-keep class com.cashhub.android.Interface.* { *; }
